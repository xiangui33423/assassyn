...
- **Runtime wrapper**: Imports `FIFO` and `TriggerCounter` from `assassyn.pycde_wrapper`, ensuring the generated design uses the same primitives as other PyCDE entry points
